...
const infusions = [
  ...
  { id: 'eisen', 
    ...
    description:'Eisen ist essentiell für unser Wohlbefinden. Der Eisenstoffwechsel gewährleistet eine gesunde Produktion von roten Blutzellen, welche den Sauerstoff und Kohlenstoffdioxid durch unser Blutsystem von und zu den Zellen transportiert. Eine Unterversorgung hat katastrophale Auswirkungen auf ihr Energielevel und eine geminderte Immunabwehr zur Folge.',
    ingredients:'Venofer 20mg',
    duration:'ca. 30 min',
    price:'ca. 133€'
  },
]
