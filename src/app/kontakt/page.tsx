              ...
              <form className="space-y-10">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="relative border-b border-[#2D3A3A]/10 pb-2 focus-within:border-[#C58695] transition-all">
                    ...
                    <input type="text" className="w-full bg-transparent border-none p-0 pt-2 text-lg text-[#2D3A3A] outline-none placeholder:text-neutral-300" placeholder="Ihr Vorname" />
                  </div>
                  <div className="relative border-b border-[#2D3A3A]/10 pb-2 focus-within:border-[#C58695] transition-all">
                    <label className="text-xs uppercase tracking-widest text-[#C58695] font-bold">Nachname</label>
                    <input type="text" className="w-full bg-transparent border-none p-0 pt-2 text-lg text-[#2D3A3A] outline-none placeholder:text-neutral-300" placeholder="Ihr Nachname" />
                  </div>
                </div>

                <div className="relative border-b border-[#2D3A3A]/10 pb-2 focus-within:border-[#C58695] transition-all">
                  <label className="text-xs uppercase tracking-widest text-[#C58695] font-bold">E-Mail Adresse</label>
                  <input type="email" className="w-full bg-transparent border-none p-0 pt-2 text-lg text-[#2D3A3A] outline-none placeholder:text-neutral-300" placeholder="beispiel@mail.de" />
                </div>

                <div className="relative border-b border-[#2D3A3A]/10 pb-2 focus-within:border-[#C58695] transition-all">
                  <label className="text-xs uppercase tracking-widest text-[#C58695] font-bold">Ihre Nachricht</label>
                  <textarea rows={4} className="w-full bg-transparent border-none p-0 pt-2 text-lg text-[#2D3A3A] outline-none placeholder:text-neutral-300 resize-none" placeholder="Wie kann ich Sie unterstützen?"></textarea>
                </div>

                <button className="group flex items-center gap-6 text-[#2D3A3A] hover:text-[#C58695] transition-colors">
                  ...
                  <span className="font-serif text-2xl italic transition-all group-hover:translate-x-2">Anfrage absenden</span>
                </button>
              </form>
            </div>
          </motion.div>
